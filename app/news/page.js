...
export default function NewsPage() {
  const articles = getAllItems('news') || []
    ...
    <div className="container" style={{ padding: '40px 24px' }}>
      ...
      <div style={{
        ...
        {articles.map(article => {
          const displayTitle = article.title || article.slug?.replace(/-/g, ' ').replace(/\b\w/g, (l) => l.toUpperCase()) || 'AI News Update'
            ...
            >
              ...
              <div style={{ padding: 18 }}>
                ...
                <p style={{ fontSize: 13, color: 'var(--text-secondary)', lineHeight: 1.5, marginBottom: 12 }}>
                  {article.meta_description ? `${article.meta_description.slice(0, 120)}...` : ''}
                </p>
